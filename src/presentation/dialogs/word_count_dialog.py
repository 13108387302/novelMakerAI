...
class WordCountDialog(QDialog):
    ...
    def _load_statistics(self):
        ...
        try:
            ...
            # 异步加载文档统计
            import asyncio
            asyncio.create_task(self._load_statistics_async(project))
    ...
    def _update_documents_table(self, documents):
        ...
        try:
            ...
            for i, doc in enumerate(documents):
                ...
                doc_type = type_names.get(doc.document_type.value, doc.document_type.value)
                ...
                # 最后修改时间
                modified_time = doc.updated_at.strftime("%Y-%m-%d %H:%M")
    ...
    def _calculate_text_analysis(self, documents):
        ...
        try:
            ...
            for doc in documents:
                if doc.document_type.value == "chapter":  # 只分析章节内容
            ...
            # 计算平均长度
            total_words = sum(len(doc.content) for doc in documents if doc.document_type.value == "chapter")
