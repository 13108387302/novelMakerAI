...
class AINovelEditorApp:
    ...
    def _register_dependencies(self) -> bool:
        ...
        self.container.register_singleton(IAIServiceRepository, AIServiceRepository)
        ...
        def create_ai_assistant_manager():
            return AIAssistantManager(self.container.get(AIService))

        self.container.register_singleton(AIService, create_ai_service)
        self.container.register_singleton(AIAssistantManager, create_ai_assistant_manager)
        self.container.register_singleton(
            SettingsService,
